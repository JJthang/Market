<template>
    <header class="w-full ">
        <div class="w-full fjc bg-[#232E48]">
            <div class="w-[60%] py-3 flex justify-end items-center">
                ...
                <div class="w-full fjc bg-[#232E48]">
                    <div class="w-[60%] flex justify-between items-center">
                        ...
                        <div class="flex justify-between items-center gap-2">
                            <div class="flex justify-start items-center gap-3 bg-[#FFFFFF] px-3 py-[10px] rounded-sm">
                                <a href="">
                                    <span class="pi pi-calendar text-[#1A489C] font-semibold pr-2"></span>
                                    <span class="text-[#1A489C] font-semibold">Dec 10 - Dec 11 </span>
                                </a>
                            </div>
                            <div class="flex justify-start items-center gap-3 bg-[#FFFFFF] px-3 py-[10px] rounded-sm">
                                <a href="">

                                    <span class="fa-solid fa-user-group text-[#1A489C] font-semibold pr-2"></span>
                                    <span class="text-[#1A489C] font-semibold">1 Room, 2 Guests </span>
                                </a>
                            </div>
                            <div class="flex justify-start items-center gap-3 bg-[#FFFFFF] px-3 py-[10px] rounded-sm">
                                <span class="fa-solid fa-tag text-[#1A489C] font-semibold"></span>
                                <span class="text-[#1A489C] font-semibold">+ Add Promo</span>
                            </div>
                        </div>
                        <div class="flex justify-between items-center gap-3">
                            ...
                            <a href="/"><span class="pi pi-phone text-base text-white"></span></a>
