<template>
    <header class="w-full ">
        <div class="w-full fjc bg-[#232E48]">
            <div class="w-[75%] py-3 flex justify-end items-center">
    ...
    <div class="w-full stick z-50 top-0">
        <div class="w-full transition-all">
            <div class="w-full flex flex-col">
                ...
                <div class="w-full fjc bg-[#232E48]">
                    <div class="lg:w-[80%] w-[95%] flex lg:flex-row justify-between flex-col items-center">
                        ...
                        <div class="flex justify-between items-center gap-2 order-2 pb-4 lg:pb-0 lg:order-1">
                        ...
                        <div class="flex  justify-between items-center gap-[100px] lg:gap-3 pb-3 order-1 lg:order-2 ">
